...
local function apply_theme(theme_name)
	...
	set(0, "LineNr", { fg = colors.orange })
	set(0, "CursorColumn", { bg = colors.cursor_line })
	set(0, "LineNrAbove", { fg = colors.grey })
	set(0, "LineNrBelow", { fg = colors.grey })
	...
	-- Treesitter
	set(0, "@annotation", { fg = colors.magenta })
	set(0, "@attribute", { fg = colors.magenta })
	set(0, "@boolean", { fg = colors.magenta })
	set(0, "@character", { fg = colors.green })
	set(0, "@character.printf", { fg = colors.yellow })
	set(0, "@character.special", { fg = colors.yellow })
	set(0, "@comment", { fg = colors.comment, italic = true })
	set(0, "@comment.error", { fg = colors.red })
	set(0, "@comment.hint", { fg = colors.blue5 })
	set(0, "@comment.info", { fg = colors.blue })
	set(0, "@comment.note", { fg = colors.blue5 })
	set(0, "@comment.todo", { fg = colors.yellow })
	set(0, "@comment.warning", { fg = colors.yellow })
	set(0, "@constant", { fg = colors.orange })
	set(0, "@constant.builtin", { fg = colors.orange })
	set(0, "@constant.macro", { fg = colors.cyan })
	set(0, "@constructor", { fg = colors.magenta })
	set(0, "@constructor.tsx", { fg = colors.blue1 })
	set(0, "@diff.delta", { bg = colors.diff_change, fg = colors.orange })
	set(0, "@diff.minus", { bg = colors.diff_delete, fg = colors.red })
	set(0, "@diff.plus", { bg = colors.diff_add, fg = colors.green })
	set(0, "@function", { fg = colors.blue })
	set(0, "@function.builtin", { fg = colors.blue })
	set(0, "@function.call", { fg = colors.blue })
	set(0, "@function.macro", { fg = colors.blue5 })
	set(0, "@function.method", { fg = colors.blue })
	set(0, "@function.method.call", { fg = colors.blue })
	set(0, "@keyword", { fg = colors.magenta })
	set(0, "@keyword.conditional", { fg = colors.magenta })
	set(0, "@keyword.coroutine", { fg = colors.magenta })
	set(0, "@keyword.debug", { fg = colors.red })
	set(0, "@keyword.directive", { fg = colors.magenta })
	set(0, "@keyword.directive.define", { fg = colors.magenta })
	set(0, "@keyword.exception", { fg = colors.red })
	set(0, "@keyword.function", { fg = colors.magenta })
	set(0, "@keyword.import", { fg = colors.cyan })
	set(0, "@keyword.operator", { fg = colors.blue5 })
	set(0, "@keyword.repeat", { fg = colors.magenta })
	set(0, "@keyword.return", { fg = colors.magenta })
	set(0, "@keyword.storage", { fg = colors.magenta })
	set(0, "@label", { fg = colors.blue })
	set(0, "@markup", {})
	set(0, "@markup.emphasis", { italic = true })
	set(0, "@markup.environment", { fg = colors.blue5 })
	set(0, "@markup.environment.name", { fg = colors.blue1 })
	set(0, "@markup.heading", { fg = colors.blue, bold = true })
	set(0, "@markup.italic", { italic = true })
	set(0, "@markup.link", { fg = colors.teal })
	set(0, "@markup.link.label", { fg = colors.yellow })
	set(0, "@markup.link.label.symbol", { fg = colors.blue })
	set(0, "@markup.link.url", { underline = true })
	set(0, "@markup.list", { fg = colors.blue5 })
	set(0, "@markup.list.checked", { fg = colors.green1 })
	set(0, "@markup.list.markdown", { fg = colors.orange, bold = true })
	set(0, "@markup.list.unchecked", { fg = colors.blue })
	set(0, "@markup.math", { fg = colors.blue5 })
	set(0, "@markup.raw", { fg = colors.green })
	set(0, "@markup.raw.markdown_inline", { bg = colors.black, fg = colors.blue })
	...
	set(0, "@module.builtin", { fg = colors.red })
	set(0, "@namespace.builtin", { fg = colors.red })
	set(0, "@none", {})
	set(0, "@number", { fg = colors.orange })
	set(0, "@number.float", { fg = colors.orange })
	set(0, "@operator", { fg = colors.blue5 })
	set(0, "@property", { fg = colors.green1 })
	...
	set(0, "@punctuation.special.markdown", { fg = colors.orange })
	set(0, "@string", { fg = colors.green })
	set(0, "@string.documentation", { fg = colors.yellow })
	set(0, "@string.escape", { fg = colors.magenta })
	set(0, "@string.regexp", { fg = colors.blue6 })
	set(0, "@tag", { fg = colors.blue })
	set(0, "@tag.attribute", { fg = colors.green1 })
	set(0, "@tag.delimiter", { fg = colors.fg })
	set(0, "@tag.delimiter.tsx", { fg = colors.blue })
	set(0, "@tag.tsx", { fg = colors.red })
	set(0, "@tag.javascript", { fg = colors.red })
	set(0, "@type", { fg = colors.blue1 })
	set(0, "@type.builtin", { fg = colors.blue1 })
	set(0, "@type.definition", { fg = colors.blue1 })
	set(0, "@type.qualifier", { fg = colors.magenta })
	set(0, "@variable", { fg = colors.fg })
	set(0, "@variable.builtin", { fg = colors.red })
	set(0, "@variable.member", { fg = colors.green1 })
	set(0, "@variable.parameter", { fg = colors.yellow })
	set(0, "@variable.parameter.builtin", { fg = colors.yellow })

	-- Rainbow headings untuk markdown
	for i, color in ipairs({ colors.blue, colors.green, colors.yellow, colors.orange, colors.red, colors.magenta }) do
		set(0, "@markup.heading." .. i .. ".markdown", { fg = color, bold = true })
	end
	-- Git
